        ...
        for (x in grid[y]) {
            ...
            if (char !== "\n" && char !== "\t" && char !== " ") { //done because some text editors see these chars
                ...
                if (typeof type == "string") {
                    ...
                    let t = new type;
                    startActors.push(t.create(x * TILE_SIZE, y * TILE_SIZE, TILE_SIZE, TILE_SIZE, 0, "rgb(255, 0, 0)")); //undefined
                }
            }
        }
    }
...
readLevel(makeGrid(levelLayout, 42)); //make sure the width is right
